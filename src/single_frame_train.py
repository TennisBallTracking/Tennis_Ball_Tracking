...
# Training csv file
csv_file = '../csv_files/train_label.csv'
...
cfg.DATASETS.TEST = ()
## TODO: the parameters below can be tuned
...
# whether to enable random cropping when training
cfg.INPUT.CROP.ENABLED = True
cfg.INPUT.CROP.SIZE = [0.5, 0.5]
cfg.DATALOADER.FILTER_EMPTY_ANNOTATIONS = False
cfg.OUTPUT_DIR = '../models/single_image_models' # can specify the output directory name
##

os.makedirs(cfg.OUTPUT_DIR, exist_ok=True)
trainer = DefaultTrainer(cfg) 
## TODO: if you want to resume training, change to "resume=True"
